...
class GiveMeTheService {
    constructor(options = {}) {
        ...
        injector.inject("services-loader", `${__dirname}/loaders/services`); // Need to be on top of injected services. services-loader constructor will inject others services. But services-loader constructor is calling after load. So default service will be overrideed.
